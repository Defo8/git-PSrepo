    ...
    class DormRoom : ILocation
    {
        ...
        {          
            ...
            while (true)
            {
                ...
                Console.WriteLine("== Dorm == " + "Calendary: " + player.PlayerTime.Calendar + " " + player.PlayerTime.Calendar.DayOfWeek);
        ...
        public void SleepInBed(Player player)
        {
            ...
            {               
                player.PlayerTime.Calendar = player.PlayerTime.Calendar.AddHours(hours);
                player.TimeConsequence.UpdateIfNeeded(player);
